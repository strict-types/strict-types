...
impl Translate<LibRef> for CompileRef {
    ...
    fn translate(
        ...
        match self {
            ...
            CompileRef::Extern(ext) => Ok(LibRef::Extern(ext.into())),
        }
    }
}
...
impl Translate<InlineRef> for CompileRef {
    ...
    fn translate(
        ...
        match self {
            ...
            CompileRef::Extern(ext) => Ok(InlineRef::Extern(ext.into())),
        }
    }
}
...
impl Translate<InlineRef1> for CompileRef {
    ...
    fn translate(
        ...
        match self {
            ...
            CompileRef::Extern(ext) => Ok(InlineRef1::Extern(ext.into())),
        }
    }
}
...
impl Translate<InlineRef2> for CompileRef {
    ...
    fn translate(
        ...
        match self {
            ...
            CompileRef::Extern(ext) => Ok(InlineRef2::Extern(ext.into())),
        }
    }
}
